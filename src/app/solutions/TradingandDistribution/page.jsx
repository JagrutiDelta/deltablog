...
import { CheckIcon, ShoppingCart, ListChecks, Barcode, ClipboardCheck, Store, Wallet, LayoutDashboard } from 'lucide-react'
import { motion } from "framer-motion"

import solution from "../../../../public/SolutionIMage.png"
import Account from "../../../../public/Trading/Account.png"
import barcodewise from "../../../../public/Trading/schedule.png"
import barcode from "../../../../public/Trading/barcode.png"
import dashboard from "../../../../public/Trading/dashboard.png"
import invenrty from "../../../../public/Trading/inventory.png"
import OnlineOrder from "../../../../public/Trading/online order.png"
import Picklist from "../../../../public/Trading/picklist automation.png"

const page = () => {

  const words = `iERP for Trading & Distribution is designed to simplify and unify complex trade processes, improving efficiency across supply chain, sales, and finance. It provides real-time visibility into inventory levels, procurement, logistics, and multi-channel sales.`;
  ...
  const featureModules = [
    {
      ...
      features: ["B2B/B2C Integration", "Real-time Order Syncing", "Status Tracking", "Payment Gateway Link", "Multi-channel Support"]
    },
    {
      title: "PickList Automation",
      image: Picklist,
      icon: <ListChecks className="w-8 h-8" />,
      features: ["Warehouse Route Optimization", "Batch Picking", "Automated Suggestions", "Resource Allocation", "Efficiency Analytics"]
    },
    {
      title: "Barcode Stock Processing",
      image: barcode,
      icon: <Barcode className="w-8 h-8" />,
      features: ["QR & Barcode Scanning", "Instant Stock Entry", "Error Reduction", "Serial Number Tracking", "Mobile Compatibility"]
    },
    {
      title: "Purchase Automation",
      image: barcodewise,
      icon: <ClipboardCheck className="w-8 h-8" />,
      features: ["Auto-reorder Logic", "Vendor Performance", "Price History", "Lead Time Tracking", "Approval Workflow"]
    },
    {
      title: "Inventory Management",
      image: invenrty,
      icon: <Store className="w-8 h-8" />,
      features: ["Multi-location Tracking", "Stock Aging Reports", "Batch & Expiry Control", "Valuation Methods", "Safety Stock Alerts"]
    },
    {
      title: "Accounts & Finance",
      image: Account,
      icon: <Wallet className="w-8 h-8" />,
      features: ["General Ledger", "Taxation (GST/VAT)", "Billing Automation", "Payables/Receivables", "Financial Reporting"]
    },
    {
      title: "AI Dashboards",
      image: dashboard,
      icon: <LayoutDashboard className="w-8 h-8" />,
      features: ["Sales Forecasting", "Inventory Insights", "Performance Metrics", "Customizable Widgets", "Real-time Drill Down"]
    }
  ]
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          >
            <div className="relative rounded-2xl p-4 bg-gradient-to-br from-white/10 to-transparent dark:from-white/5 dark:to-transparent backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-2xl">
              <Image
                src={solution}
                alt="Trading and Distribution ERP"
                width={600}
                height={600}
      ...
      <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            iERP for <span className="text-teal-500">Trading & Distribution</span>
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            A specialized suite designed to bridge the gap between supply chain complexity and operational excellence.
          </p>
        </motion.div>
