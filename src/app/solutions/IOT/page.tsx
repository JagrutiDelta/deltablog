...
import { Database, Monitor, Network, Satellite, Shield, Settings, ShieldCheck, Laptop, Smartphone, PlayCircle } from "lucide-react"
import { motion } from "framer-motion"

import iStock from "../../../../public/ProductLogo/IOT.png"
import light from "../../../../public/Flows/IotLight.png"
import darkflow from "../../../../public/Flows/IotDark.png"

const page = () => {

    const words = `Delta IoT is a cutting-edge Internet of Things (IoT) solution designed to revolutionize the way you connect, control, and optimize your smart devices. This comprehensive system integrates physical devices, vehicles, home appliances, and other items embedded with electronics, software, sensors, and network connectivity.`;

    const features = [
        {
            title: "Device Connectivity",
            description: "Ensures smooth communication and interaction between IoT devices, sensors, and actuators for efficient data sharing.",
        ...
        },
        {
            ...
            description: "Collects and consolidates data from various IoT devices to provide centralized data analysis and processing capabilities.",
            icon: <Database className="w-16 h-16 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Real-time Monitoring",
            description: "Offers real-time monitoring and control features for immediate tracking of device status and environmental conditions.",
        ...
        },
        {
            ...
            description: "Enables remote management and configuration of IoT devices, allowing updates, adjustments, and issue resolution from any location.",
            icon: <Satellite className="w-16 h-16 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Security Measures",
            description: "Implements robust security protocols to secure data transmissions, ensure device authentication, and prevent cybersecurity threats.",
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">IoT</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your IoT operations with precision and ease.
                    </p>
                </motion.div>
