...
import { Database, MessageCircleCodeIcon, Monitor, Network, NotebookText, Users2Icon, Settings, ShieldCheck, Laptop, Smartphone, PlayCircle } from "lucide-react"
import { motion } from "framer-motion"

import kanban from "../../../../public/ProductLogo/Kanban.png"
import darkflow from "../../../../public/Flows/kanbanDark.png"
import light from "../../../../public/Flows/kanbanLight.png"

const page = () => {

    const words = `Kanban is a powerful method for managing and visualizing work, widely used in both software development and manufacturing. The term "kanban" translates to "signboard" or "billboard" in Japanese, reflecting the use of physical or virtual cards to track work items.`;

    const features = [
        {
            title: "Visualizing Work",
            description: "The work is represented by cards or sticky notes that are placed on a board, making it easy to see the state of work and progress.",
            icon: <Network className="w-16 h-16 text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Limiting Work in Progress",
            description: "The goal is to have a small number of items in progress at any one time, allowing teams to focus and complete work more efficiently.",
            icon: <NotebookText className="w-16 h-16 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Making Process Policies Explicit",
            description: "The rules for how work is to be done are made clear, enabling teams to work more effectively and reducing the likelihood of misunderstandings.",
            icon: <Monitor className="w-16 h-16 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Improving Collaboratively",
            description: "Teams continuously work to improve their processes and work together to find better ways of doing things.",
            icon: <Users2Icon className="w-16 h-16 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Implementing Feedback Loops",
            description: "Feedback is regularly sought from customers and stakeholders to ensure that the work being done is delivering value.",
            icon: <MessageCircleCodeIcon className="w-16 h-16 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform duration-300" />
        }
    ]
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">Kanban</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your workflow management process with precision and ease.
                    </p>
                </motion.div>
