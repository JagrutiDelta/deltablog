...
import { AlertCircle, BookAudio, ClipboardList, FilePlus, Layers, ListChecks, MapIcon, PieChart, Repeat, ScanTextIcon, Truck, Check, ShieldCheck, Laptop, Smartphone, PlayCircle, Settings, Box, BarChart3, TrendingUp } from "lucide-react"
import { motion } from "framer-motion"

import Inventory from "../../../../public/ProductLogo/Inventory.png"
import darkflow from "../../../../public/Flows/inventeryDark.png"
import light from "../../../../public/Flows/inventryLight.png"


const page = () => {

    const words = `DeltaInventory optimizes inventory management with cutting-edge technology for seamless operations and enhanced decision-making, ensuring efficiency and accuracy.`;

    const features = [
        {
            title: "Min Level and Max Level",
            description: "Set minimum and maximum inventory levels to optimize stock control and prevent stockouts.",
            icon: <Layers className="w-16 h-16 text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Reorder Level",
            description: "Automatically generate reorder alerts based on preset inventory thresholds to maintain optimal stock levels.",
            icon: <AlertCircle className="w-16 h-16 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Purchase Requisition",
            description: "Streamline the process of requesting and approving purchases to ensure timely stock replenishment.",
            icon: <FilePlus className="w-16 h-16 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Purchase Requisition Tracking",
            description: "Track the status and progress of purchase requisitions to monitor procurement efficiency.",
            icon: <ListChecks className="w-16 h-16 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Material Issue Slip",
            description: "Facilitate the issuance of materials from inventory with organized documentation and tracking.",
            icon: <PieChart className="w-16 h-16 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Stock Convert Option",
            description: "Convert and manage stock items between different units or forms within the inventory system.",
            icon: <Repeat className="w-16 h-16 text-red-600 dark:text-red-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Job-work Reports",
            description: "Generate comprehensive reports on job-work activities, providing insights into productivity and costs.",
            icon: <BookAudio className="w-16 h-16 text-green-600 dark:text-green-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Job-work Outward/Inward",
            description: "Manage outward and inward job-work processes efficiently with detailed tracking and documentation.",
            icon: <Truck className="w-16 h-16 text-yellow-600 dark:text-yellow-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Multiple Stock Reports",
            description: "Access various detailed reports on stock levels, transactions, and trends to support informed decision-making.",
            icon: <ClipboardList className="w-16 h-16 text-pink-600 dark:text-pink-400 group-hover:scale-110 transition-transform duration-300" />
        }
    ]
    ...
    const implementationMeasures = [
        {
            ...
            description: "Conduct a comprehensive evaluation of inventory management requirements, including stock volume, turnover rates, and storage constraints.",
            icon: <Box className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Customization",
            description: "Customize the software to align with specific stock management workflows, product categories, and reporting structures unique to the organization.",
            icon: <Settings className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Data Migration",
            description: "Ensure seamless migration of existing stock data into the new software while maintaining data integrity.",
            icon: <Laptop className="w-8 h-8 text-teal-500" />
        },
        {
            title: "User Training",
            description: "Provide thorough training sessions for inventory managers, warehouse staff, and procurement teams to ensure effective utilization.",
            icon: <PlayCircle className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Continuous Improvement",
            description: "Implement regular reviews, performance evaluations, and feedback mechanisms to continuously optimize inventory management processes.",
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
                    ...
                    >
                        <div className="relative rounded-2xl p-4 bg-gradient-to-br from-white/10 to-transparent dark:from-white/5 dark:to-transparent backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-2xl">
                            <Image
                                src={Inventory}
                                alt="Delta Inventory Application"
                                width={550}
                                height={600}
                            ...
                            <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-orange-500/20 rounded-full blur-3xl animate-pulse mix-blend-multiply" />
                        </div>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">DeltaInventory</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your stock control process.
                    </p>
                </motion.div>
            ...
            <section className="py-24 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                <div className="relative bg-gray-50 dark:bg-neutral-900/50 rounded-[3rem] p-8 md:p-16 border border-gray-100 dark:border-neutral-800 overflow-hidden">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                            Strategized rollout for maximum efficiency and adoption.
                        </p>
                    </motion.div>
