...
import { CreditCard, Eye, Fingerprint, Link as LinkIcon, Settings, Settings as SettingsIcon, ShieldCheck, Laptop, Smartphone, PlayCircle, Database } from "lucide-react"
import { motion } from "framer-motion"

import GateModule from "../../../../public/ProductLogo/GateModule.png"
import darkflow from "../../../../public/Flows/GateModuleDark.png"
import light from "../../../../public/Flows/GateModuleLight.png"

const page = () => {

    const words = `Delta's Gate Module is an advanced access control system that enhances security and simplifies entry and exit processes. Utilizing state-of-the-art technology, it ensures secure access to designated areas within a facility.`;

    const features = [
        {
            title: "Biometric Access Control",
            description: "Incorporates biometric authentication such as fingerprint or facial recognition for enhanced security.",
        ...
        },
        {
            ...
            description: "Supports RFID technology for convenient access using keycards or fobs.",
            icon: <CreditCard className="w-16 h-16 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Real-time Monitoring",
            description: "Provides real-time monitoring of entry and exit activities for better security management.",
            icon: <Eye className="w-16 h-16 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Customizable Access Levels",
            description: "Allows customization of access levels for different users based on roles and permissions.",
        ...
        },
        {
            ...
            description: "Can be integrated with other systems such as CCTV cameras for comprehensive security solutions.",
    ...
    const implementationMeasures = [
        {
            title: "Conduct a Site Assessment",
            description: "Evaluate the specific requirements and layout of the premises to determine the optimal placement of gate modules.",
            icon: <SettingsIcon className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Installation and Configuration",
            description: "Deploy the gate modules at strategic entry points and configure them according to the access control policies.",
            icon: <Laptop className="w-8 h-8 text-teal-500" />
        },
        {
            title: "User Training",
            description: "Provide training to staff members on how to use the gate module effectively and adhere to security protocols.",
            icon: <PlayCircle className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Testing and Validation",
            description: "Conduct thorough testing to ensure the gate module functions correctly and integrates seamlessly with existing security systems.",
            icon: <ShieldCheck className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Ongoing Maintenance",
            description: "Establish a maintenance schedule to regularly inspect and update the gate modules to maintain optimal performance and security levels.",
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">GateModule</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your security management process with precision and ease.
                    </p>
                </motion.div>
