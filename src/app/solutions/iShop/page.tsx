...
import { ArrowLeftRight, FileDigitIcon, LayoutDashboard, Monitor, Network, Settings, ShieldCheck, Laptop, Smartphone, PlayCircle, Database } from "lucide-react"
import { motion } from "framer-motion"

import iShop from "../../../../public/ProductLogo/iShop.png"
import darkflow from "../../../../public/Flows/iShopDark.png"
import light from "../../../../public/Flows/iShopLight.png"

const page = () => {

    const words = `iShop is a state-of-the-art platform engineered to transform manufacturing operations into a seamless digital ecosystem. It eliminates the need for paper-based processes, thereby enhancing efficiency and accuracy in production management.`;

    const features = [
        {
            title: "Digital Workflow Management",
            description: "Streamline your production processes with intuitive digital workflows that ensure every task is tracked and managed in real-time.",
            icon: <Monitor className="w-16 h-16 text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Real-Time Data Analytics",
            description: "Gain insights into your production data with powerful analytics tools, enabling informed decision-making and continuous improvement.",
            icon: <LayoutDashboard className="w-16 h-16 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Paperless Operations",
            description: "Transition to a completely paperless environment, reducing waste and optimizing resource utilization.",
            icon: <FileDigitIcon className="w-16 h-16 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Enhanced Communication",
            description: "Improve communication between operators and production managers with instant digital updates and notifications.",
            icon: <Network className="w-16 h-16 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Customizable Dashboards",
            description: "Tailor your production dashboards to display the most relevant information for your specific needs, enhancing visibility and control.",
            icon: <LayoutDashboard className="w-16 h-16 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Integration Capabilities",
            description: "Seamlessly integrate iShop with existing systems and machinery for a unified production management experience.",
            icon: <ArrowLeftRight className="w-16 h-16 text-red-600 dark:text-red-400 group-hover:scale-110 transition-transform duration-300" />
        }
    ]
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">iShop</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your manufacturing process with precision and ease.
                    </p>
                </motion.div>
