...
import { BarChart2, DollarSign, ListChecks, Users, Settings, ShieldCheck, Laptop, Smartphone, PlayCircle, Database } from "lucide-react"
import { motion } from "framer-motion"

import PPC from "../../../../public/ProductLogo/PPC.png"
import darkflow from "../../../../public/Flows/PPCDark.png"
import light from "../../../../public/Flows/PPCLight.png"

const page = () => {

    const words = `The project planning and control connect module software developed by Delta Info Soft is a comprehensive tool designed to streamline project management processes. This robust platform empowers organizations to efficiently plan, monitor, and control projects from inception to completion.`;

    const features = [
        {
            title: "Work Breakdown Structure (WBS)",
            description: "Allows for the breakdown of project scope into manageable tasks, work packages, and control accounts for detailed project planning and tracking.",
            icon: <ListChecks className="w-16 h-16 text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Gantt Chart Visualization",
            description: "Provides interactive Gantt charts to visualize project timelines, dependencies, and critical path analysis for effective scheduling.",
            icon: <BarChart2 className="w-16 h-16 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Resource Management",
            description: "Enables resource allocation, tracking, and optimization to ensure that project teams are adequately staffed and utilized.",
            icon: <Users className="w-16 h-16 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Budgeting and Cost Control",
            description: "Facilitates budget creation, cost estimation, tracking, and variance analysis to maintain project financial health.",
            icon: <DollarSign className="w-16 h-16 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Collaboration Tools",
            description: "Offers communication and collaboration features for project teams to share updates, documents, and progress reports in real-time.",
    ...
    const implementationMeasures = [
        {
            ...
            description: "Conduct a thorough analysis of project management requirements, including stakeholder expectations, project scope, and deliverables.",
            icon: <Settings className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Customization and Configuration",
            description: "Customize the software to align with specific project methodologies, workflows, and reporting requirements within the organization.",
            icon: <Laptop className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Training and Onboarding",
            description: "Provide comprehensive training sessions for project managers, team members, and stakeholders to ensure effective utilization of the software.",
            icon: <PlayCircle className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Data Integration",
            description: "Integrate the project planning and control software with other systems such as ERP or time tracking tools to streamline data flow and reporting.",
            icon: <Database className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Continuous Monitoring and Improvement",
            description: "Implement regular project reviews, performance evaluations, and feedback mechanisms to continuously optimize project planning and control processes based on insights gained from the software.",
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">PPC</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your project management process with precision and ease.
                    </p>
                </motion.div>
