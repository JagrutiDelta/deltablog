...
import { BookOpen, ClipboardList, Clock, FilePlus, FileText, Truck, Settings, ShieldCheck, Laptop, Smartphone, PlayCircle } from "lucide-react"
import { motion } from "framer-motion"

import Iaccount from "../../../../public/ProductLogo/Delta iVendor Connect.png"
import darkflow from "../../../../public/Flows/iVendorDark.png"
import light from "../../../../public/Flows/ivendorlight.png"

const page = () => {

    const words = `iVendor, developed by Delta Info Soft, is a sophisticated platform designed to revolutionize the way businesses manage their vendor relationships. As a centralized hub, iVendor streamlines communication and collaboration with vendors, making it easier to facilitate transactions and enhance overall supply chain efficiency.`;

    const features = [
        {
            title: "Purchase Order",
            description: "Create and manage purchase orders efficiently to streamline procurement.",
        ...
        },
        {
            ...
            description: "Track and review all pending orders to ensure timely fulfillment.",
        ...
        {
            title: "Rate Contract",
            description: "Manage and maintain vendor rate contracts for consistent pricing and terms.",
        ...
        {
            title: "Ledger Report",
            description: "Access detailed ledger reports for accurate financial tracking and analysis.",
            icon: <BookOpen className="w-16 h-16 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Dispatch Entry",
            description: "Record and manage dispatch entries to ensure accurate inventory updates.",
            icon: <Truck className="w-16 h-16 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Dispatch Report",
            description: "Generate comprehensive dispatch reports for clear visibility of shipped goods.",
            icon: <ClipboardList className="w-16 h-16 text-red-600 dark:text-red-400 group-hover:scale-110 transition-transform duration-300" />
        }
    ]
    ...
    const implementationMeasures = [
        {
            ...
            description: "Establish a structured onboarding process to introduce vendors to the software and provide training on its functionalities.",
            icon: <PlayCircle className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Data Integration",
            description: "Integrate the vendor connect module software with existing systems such as ERP or CRM to ensure seamless data flow.",
            icon: <Settings className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Customization",
            description: "Customize the software to align with specific vendor management workflows and requirements within your organization.",
            icon: <Laptop className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Security Measures",
            description: "Implement robust security protocols to safeguard sensitive vendor information and ensure data privacy.",
            icon: <ShieldCheck className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Continuous Improvement",
            description: "Gather feedback from users and vendors to continually enhance the software's features and functionality based on evolving needs and industry trends.",
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">iVendor</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your vendor management process with precision and ease.
                    </p>
                </motion.div>
