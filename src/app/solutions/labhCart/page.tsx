...
import { BarChart, Cpu, Expand, Shield, TrendingUp, Settings, ShieldCheck, Laptop, Smartphone, PlayCircle, Database, ShoppingCart } from "lucide-react"
import { motion } from "framer-motion"

import Barcode from "../../../../public/ProductLogo/Labhcart.png"
import darkflow from "../../../../public/Flows/labhCardDark.png"
import light from "../../../../public/Flows/LabhCartLight.png"

const page = () => {

    const words = `Labhcart is a cutting-edge solution designed to help trading organizations scale their business efficiently. By integrating POS and barcode technologies, Labhcart significantly improves operational efficiency, simplifying processes such as inventory management, sales tracking, and customer transactions.`;

    const features = [
        {
            title: "Integrated POS System",
            description: "Streamlines sales processes with a robust Point of Sale system, enabling efficient transaction handling and customer management.",
            icon: <ShoppingCart className="w-16 h-16 text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Barcode Integration",
            description: "Enhances inventory tracking and management through seamless barcode scanning, reducing manual errors and speeding up operations.",
            icon: <Cpu className="w-16 h-16 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Real-time Inventory Management",
            description: "Provides up-to-date visibility into stock levels, helping businesses maintain optimal inventory and prevent stockouts or overstocking.",
            icon: <TrendingUp className="w-16 h-16 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Unified Accounting System",
            description: "Eliminates the need for separate accounting software by integrating financial management, ensuring accurate and comprehensive financial records.",
        ...
        },
        {
            ...
            description: "Automatically calculates and manages taxes, ensuring compliance with local and national tax regulations without the need for additional software.",
        ...
        },
        {
            ...
            description: "Offers detailed sales reports and analytics, allowing businesses to gain insights into sales trends, customer preferences, and overall performance.",
            icon: <Expand className="w-16 h-16 text-red-600 dark:text-red-400 group-hover:scale-110 transition-transform duration-300" />
        }
    ]
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">Labhcart</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your trading operations with precision and ease.
                    </p>
                </motion.div>
