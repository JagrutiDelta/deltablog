...
import { BarChart, Cpu, Expand, Shield, TrendingUp, Settings, ShieldCheck, Laptop, Smartphone, PlayCircle, Database } from "lucide-react"
import { motion } from "framer-motion"

import Barcode from "../../../../public/ProductLogo/Delta BigData.png"
import darkflow from "../../../../public/Flows/Big DataDark.png"
import light from "../../../../public/Flows/Big DataLight.png"

const page = () => {

    const words = `Delta's big data module software is a powerful solution designed to manage and analyze vast amounts of data, enabling businesses to make data-driven decisions with confidence. Leveraging advanced algorithms and state-of-the-art analytics, the software processes, analyzes, and visualizes complex data sets from various sources.`;

    const features = [
        {
            title: "Data Processing",
            description: "Capable of processing massive amounts of structured and unstructured data in real-time to extract meaningful information.",
            icon: <Cpu className="w-16 h-16 text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Advanced Analytics",
            description: "Offers advanced analytical tools such as machine learning algorithms, predictive modeling, and data mining for in-depth data analysis.",
            icon: <TrendingUp className="w-16 h-16 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Scalability",
            description: "Provides scalability to handle growing data volumes and accommodate changing business needs without compromising performance.",
            icon: <Expand className="w-16 h-16 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Data Visualization",
            description: "Enables interactive and customizable data visualization tools to present insights in a clear and actionable format for users.",
            icon: <BarChart className="w-16 h-16 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Data Security",
            description: "Implements robust data security measures to ensure data privacy, compliance with regulations, and protection against unauthorized access.",
            icon: <Shield className="w-16 h-16 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform duration-300" />
        }
    ]
    ...
    const implementationMeasures = [
        {
            ...
            description: "Conduct a thorough assessment of existing data sources, quality, and requirements to determine the scope and objectives of the big data module implementation.",
            icon: <Settings className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Infrastructure Setup",
            description: "Establish a scalable and secure infrastructure environment including data storage, processing capabilities, and integration with data sources.",
            icon: <Laptop className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Data Integration",
            description: "Integrate data from various sources such as databases, applications, and IoT devices into the big data module for comprehensive analysis.",
            icon: <Database className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Algorithm Selection",
            description: "Choose appropriate algorithms and analytical techniques based on the specific use cases and desired outcomes for data analysis and insights generation.",
            icon: <PlayCircle className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Training and Support",
            description: "Provide training sessions for users on utilizing the big data module software effectively, and offer ongoing support to address any issues or optimize usage for maximum benefit.",
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">BigData</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your data analytics process with precision and ease.
                    </p>
                </motion.div>
