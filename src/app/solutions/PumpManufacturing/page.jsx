...
import service from "../../../../public/SolutionHeroscreen/Pump.png"
import production from "../../../../public/PumpSolution/Pumps/1 Production.png"
import schedule from "../../../../public/PumpSolution/Pumps/2 Production Schedule.png"
import MR from "../../../../public/PumpSolution/Pumps/3 MR.png"
import PO from "../../../../public/PumpSolution/Pumps/4 PO.png"
import BOM from "../../../../public/PumpSolution/Pumps/5 BOM.png"
import QM from "../../../../public/PumpSolution/Pumps/6 QM.png"
import JobWOrk from "../../../../public/PumpSolution/Pumps/7 job work.png"
import sir from "../../../../public/PumpSolution/Pumps/8 SIR.png"
import Supplier from "../../../../public/PumpSolution/Pumps/9 supplier.png"
import Com from "../../../../public/PumpSolution/Pumps/10  C & OM.png"
import Maintanace from "../../../../public/PumpSolution/Pumps/11 Maintenance.png"
import finance from "../../../../public/PumpSolution/Pumps/12 finance.png"
import Image from 'next/image'
import { TextGenerateEffect } from '@/components/ui/text-generate-effect'
import RetroGrid from '@/components/magicui/retro-grid'
import { CheckIcon, Box, Factory, ClipboardCheck, Truck, Wallet, Megaphone, Wrench, Users, Store, Calendar, FileClock, ClipboardList, Package, ListChecks, Settings2 } from 'lucide-react'
  ...
  const featureModules = [
    {
      ...
      features: ["Shop Floor Scheduling", "Machine Loading", "Operation Tracking", "Operator Performance", "Daily Production Reporting", "Real-time Monitoring"]
    },
    {
      title: "Master Production Schedule",
      image: schedule,
      icon: <Calendar className="w-8 h-8" />,
      features: ["Forecast-based Scheduling", "Order-driven Production", "Resource Allocation", "Capacity Planning", "Timeline Management"]
    },
    {
      title: "Material Requirement Planning",
      image: MR,
      icon: <ClipboardList className="w-8 h-8" />,
      features: ["Demand Forecasting", "Automatic Requisition", "Scarcity Analysis", "Safety Stock Management", "Lead Time Optimization"]
    },
    {
      title: "Production Order",
      image: PO,
      icon: <FileClock className="w-8 h-8" />,
      features: ["Order Release", "Routing Control", "BOM Selection", "Progress Tracking", "Status Updates", "Cost Tracking"]
    },
    {
      title: "Bill of Material",
      image: BOM,
      icon: <ListChecks className="w-8 h-8" />,
      features: ["Multi-level BOM", "Engineering Change Orders", "Version Control", "Component Tracking", "Recipe Management"]
    },
    {
      title: "Quality Management",
      image: QM,
      icon: <ClipboardCheck className="w-8 h-8" />,
      features: ["In-process QC", "Final Inspection", "Testing Reports", "Rejection Analysis", "Compliance Management"]
    },
    {
      title: "Production Job Work",
      image: JobWOrk,
      icon: <Settings2 className="w-8 h-8" />,
      features: ["Subcontracting Control", "Material Reconciliation", "Job-work Inward/Outward", "Vendor Performance", "Process Outsourcing"]
    },
    {
      title: "Stores & Inventory",
      image: sir,
      icon: <Package className="w-8 h-8" />,
      features: ["GRN Management", "Stock Levels", "Batch Tracking", "Bin Management", "Inventory Auditing", "Valuation Reports"]
    },
    {
      title: "Supplier & Purchase",
      image: Supplier,
      icon: <Store className="w-8 h-8" />,
      features: ["Vendor Portal", "PO Tracking", "Price Comparison", "Rating System", "Automated Procurement"]
    },
    {
      title: "Customer & Order",
      image: Com,
      icon: <Users className="w-8 h-8" />,
      features: ["Sales Order Management", "Dispatch Scheduling", "Customer Invoicing", "CRM Integration", "Status Notifications"]
    },
    {
      title: "Plant Maintenance",
      image: Maintanace,
      icon: <Wrench className="w-8 h-8" />,
      features: ["Preventive Maintenance", "Breakdown Alerts", "Spare Part Tracking", "Equipment Lifecycle", "Maintenance History"]
    },
    {
      title: "Accounts & Finance",
      image: finance,
      icon: <Wallet className="w-8 h-8" />,
      features: ["General Ledger", "Taxation (GST/TDS)", "Costing Analysis", "Receivable/Payable", "Financial Reporting"]
    }
  ]
      ...
      <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            iERP for <span className="text-teal-500">Pump Manufacturing</span>
          </h2>
