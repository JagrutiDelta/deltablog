...
import { FilePlus, Layers, Link as LinkIcon, MapIcon, ScanLine, Settings, ShieldCheck, Laptop, Smartphone, PlayCircle } from "lucide-react"
import { motion } from "framer-motion"

import Barcode from "../../../../public/ProductLogo/Barcode.png"
import darkflow from "../../../../public/Flows/BarcodeDark.png"
import light from "../../../../public/Flows/BarcodeLight.png"

const page = () => {

    const words = `Delta's barcode module software is a sophisticated solution tailored to elevate efficiency and accuracy in inventory and warehouse management processes. Leveraging advanced barcode technology, the software enhances the tracking, identification, and control of stock items within warehouses or distribution centers.`;

    const features = [
        {
            title: "Barcode Generation",
            description: "Enables the creation and printing of custom barcodes for products, inventory items, and locations within the warehouse.",
            icon: <FilePlus className="w-16 h-16 text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Barcode Scanning",
            description: "Supports barcode scanning functionality for quick and error-free data entry, stock counting, and order fulfillment processes.",
            icon: <ScanLine className="w-16 h-16 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Real-time Tracking",
            description: "Provides real-time visibility into stock movements, inventory levels, and item locations using barcode scans.",
            icon: <MapIcon className="w-16 h-16 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Inventory Control",
            description: "Facilitates accurate stock reconciliation, cycle counting, and stock adjustments through barcode-enabled processes.",
            icon: <Layers className="w-16 h-16 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300" />
        },
        {
            title: "Integration Capabilities",
            description: "Integrates seamlessly with existing inventory management systems, ERP software, and warehouse management systems for data synchronization and workflow optimization.",
            icon: <LinkIcon className="w-16 h-16 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform duration-300" />
        }
    ]
    ...
    const implementationMeasures = [
        {
            ...
            description: "Conduct a detailed assessment of inventory and warehouse barcode requirements, including identifying key areas for barcode implementation.",
            icon: <Settings className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Barcode Labeling",
            description: "Choose appropriate barcode labels based on durability, size, and scanning requirements for different inventory items and storage locations.",
            icon: <Laptop className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Training and Adoption",
            description: "Provide training sessions for warehouse staff on proper barcode scanning techniques, label placement, and system usage to ensure effective adoption.",
            icon: <PlayCircle className="w-8 h-8 text-teal-500" />
        },
        {
            title: "System Integration",
            description: "Integrate the barcode module software with existing warehouse management systems and hardware devices such as barcode scanners and printers.",
            icon: <Smartphone className="w-8 h-8 text-teal-500" />
        },
        {
            title: "Quality Assurance",
            description: "Implement quality control measures to validate barcode readability, accuracy of scanned data, and overall system performance to optimize inventory management processes.",
            ...
            <section className="py-20 px-4 md:px-6 lg:px-8 max-w-[1600px] mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        Powerful Features of <span className="text-teal-500">Barcode</span>
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                        Comprehensive modules designed to optimize every aspect of your inventory management process with precision and ease.
                    </p>
                </motion.div>
